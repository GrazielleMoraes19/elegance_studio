      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <button class="btn btn-primary"  style= "background-color: #4e0303" type="submit">Login</button>
        	</div>
          ...
          <div align="center"><small><a href="#"style= "color: #4e0303" data-bs-toggle="modal" data-bs-target="#modalRecuperar">Recuperar Senha</a></small></div>
